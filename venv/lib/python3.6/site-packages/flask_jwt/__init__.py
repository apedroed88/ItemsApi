...
def _jwt_required(realm):
    ...
    if identity is None:
        raise JWTError('Invalid JWT', 'UserModel does not exist')
    ...
    def authentication_handler(self, callback):
        ...
        object representing an authenticated identity. Example::
            ...
            def authenticate(username, password):
                user = UserModel.query.filter(UserModel.username == username).scalar()
    ...
    def identity_handler(self, callback):
        ...
        being the JWT payload. For example::
            ...
            def identify(payload):
                return UserModel.query.filter(UserModel.id == payload['identity']).scalar()
